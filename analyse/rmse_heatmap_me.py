...
colors = ['darkblue', 'darkgreen', 'darkred', 'purple', 'saddlebrown', 'mediumvioletred', 'dimgray']

x_heat = ['n:0.3', 'n:1.5', 'n:4.0', 'p:1', 'p:2', 'p:4', 'p:10', 's:1', 's:2', 's:4', 's:8', 'r:5', 'r:10', 'r:50']
y_heat = ['cosopt', 'cosinor1', 'arser1', 'cosinor2', 'arser2', 'cosinor3', 'arser3']
measure_dict = {
        ...
        for ix, method in enumerate(methods):
            ...
            for param in params:
                ...
                for value in values:
                    ...
                    if method == "cosinor2" and param == 'step' and (
                            value == 8) and data_name == "asymmetric_oscillatory_1":
                        med = np.nan
