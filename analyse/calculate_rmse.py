...
plotter.subplot_model(X_test, Y_1, X_test, Y_1, ax, plot_model=True, plot_measurements=False,
                      fit_label='simetrični ritmični', color='red')
plotter.subplot_model(X_test, Y_2, X_test, Y_2, ax, plot_model=True, plot_measurements=False,
                      fit_label='1.serija asimetrični ritmični', color='blue')
