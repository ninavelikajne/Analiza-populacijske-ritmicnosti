...
plotter.subplot_model(X_test, Y_1, X_test, Y_1, ax, plot_model=True, plot_measurements=False, fit_label='simetrični ritmični', color='red')
plotter.subplot_model(X_test, Y_2, X_test, Y_2, ax, plot_model=True, plot_measurements=False, fit_label='1.serija asimetrični ritmični', color='blue')
plotter.subplot_model(X_test, Y_3, X_test, Y_3, ax, plot_model=True, plot_measurements=False, fit_label='2.serija asimetrični ritmični', color='green')
ax.legend()
...
og_df=pd.read_csv('../results/sep_classification.csv')
...
df_results.to_csv('../results/rmse.csv',index=False)
