...
def calculate_confidence_intervals_parameters_cosinor(df, predict_var, time_var, group_var, variables=None,
    ...
    for i in range(0, repetitions):
        ...
        df_result = gee_cosinor(sample, predict_var, time_var, group_var, interactions=interactions,
                                variables=variables, n_components=n_components, period=period, plot=False)
